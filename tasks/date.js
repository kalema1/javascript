...
let d = parseDataFromRfc2822("December 17, 1995 03:24:00");
console.log(d);
...
let dateValue = parseDataFromIso8601("2016-01-19T16:07:37+00:00");
...
function timeSpanToString(startDate, endDate) {
  ...
  const hours = timeDifference.getUTCHours().toString().padStart(2, "0");
...
function angleBetweenClockHands(date) {
  ...
  // Take the smaller angle (between clockwise and counterclockwise)
  if (angle > 180) {
    angle = 360 - angle;
  }

  // Convert the angle to radians and return
