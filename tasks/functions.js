...
console.log(getPowerFunction(0.5)(4));
...
function getPolynom(...coefficients) {
  // Check if no coefficients are provided
  ...
  return function () {
    for (let i = 0; i < attempts; i++) {
      try {
        ...
        // If an error is thrown, continue to the next attempt
        if (i === attempts - 1) {
          throw error; // If all attempts failed, rethrow the error
        }
      }
    }
  };
...
var partiallyApplied1 = partialUsingArguments(fn, "a")("b", "c", "d");
console.log(partiallyApplied1);
...
var getId10 = getIdGeneratorFunction(10);
